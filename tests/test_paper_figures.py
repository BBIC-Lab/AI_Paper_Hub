...
class PaperFiguresTest(unittest.TestCase):
    ...
    def test_sort_figures_by_pdf_page_then_caption_number(self):
        figures = [
            {"url": "fig-001.webp", "caption": "Figure 12: Late appendix figure", "page": 25, "index": 1},
            {"url": "fig-002.webp", "caption": "Figure 1: Early overview", "page": 2, "index": 2},
            {"url": "fig-003.webp", "caption": "Figure 10: Later same-page figure", "page": 4, "index": 3},
            {"url": "fig-004.webp", "caption": "Figure 2: Earlier same-page figure", "page": 4, "index": 4},
        ]

        ordered = self.mod._sort_figures_by_pdf_order(figures)

        self.assertEqual(
            [figure["url"] for figure in ordered],
            ["fig-002.webp", "fig-004.webp", "fig-003.webp", "fig-001.webp"],
        )

    def test_sort_figures_keeps_unknown_captions_after_numbered_same_page_items(self):
        figures = [
            {"url": "fig-001.webp", "caption": "", "page": 7, "index": 1},
            {"url": "fig-002.webp", "caption": "Fig. 2b: Detail", "page": 7, "index": 2},
            {"url": "fig-003.webp", "caption": "Fig. 2a: Detail", "page": 7, "index": 3},
            {"url": "fig-004.webp", "caption": "Table 3: Metrics", "page": 7, "index": 4},
        ]
        ...
        self.assertEqual(
            [figure["url"] for figure in ordered],
            ["fig-003.webp", "fig-002.webp", "fig-004.webp", "fig-001.webp"],
        )
