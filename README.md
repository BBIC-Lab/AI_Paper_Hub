...
* **2026-06-01** 🗓️ 周报 V2.4 调整入口与详情页卡片排版，优化词频云、主题演化、主题共现和代表论文证据的审阅体验。
* **2026-05-31** 📊 新增周报/月报工作流，默认复用日报 artifact 生成低成本趋势 dashboard，并在设置页提供周期报告配置和快捷触发入口。
* **2026-05-29** 🗓️ `daily-paper-reader` 改为北京时间工作日凌晨自动运行，默认回溯 5 天并将顺延窗口调为 7 天。
* **2026-05-29** 🖍️ 论文页新增正文高亮，可选中文本后选择颜色，点击旧高亮可改色或删除，并在解锁后自动同步到仓库。
* **2026-05-29** 🗄️ 设置页新增运行态存储管理，可按单篇、单日/批次或完整集合移入回收站，并按原路径恢复。
* **2026-05-28** 🎨 日报与论文报告页升级为沉稳白底卡片布局，新增阅读路线、主题概览与插图画廊。
* **2026-05-28** 🧭 隐私设置新增研究方向配置，AI 精读报告会在最后以卡片呈现论文对读者方向的启发。
* **2026-05-28** ⚡️ 本地 PDF 批量精读改为一次批次触发，复用后台环境并统一提交生成结果。
* **2026-05-27** 🧾 本地 PDF 精读报告修复插图展示，并按当前订阅方向生成“订阅评分”。
* **2026-05-27** 📚 本地 PDF 解析支持多次追加导入、改标题和单篇删除。
* **2026-05-26** 📄 本地 PDF 解析新增 GitHub Actions 后台精读流程，可在 GitHub Pages 上传论文并生成与日报精读区一致的页面、摘要和插图。
* **2026-05-26** 🗑️ 侧边栏精读区/速读区新增悬浮删除按钮，解锁后可通过确认弹窗移除条目，并同步清理对应 Markdown、TXT、PDF 与插图资源。
