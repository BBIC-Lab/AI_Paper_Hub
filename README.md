...
* **2026-06-10** 🧠 设置页密钥配置支持自建 Embedding 与 Reranker 服务，可分别写入 endpoint、模型和 API Key。
* **2026-06-05** 🗂️ 侧边栏 Daily Papers 更名为「近期日报」，仅保留最近 7 个日报入口并统一顶层栏目高度。
* **2026-06-04** ⏸️ 设置页新增自动日报开关，可暂停或恢复定时日报，手动快速抓取不受影响。
* **2026-06-04** 🗂️ 论文页阅读标记升级为加密个人论文库，支持收藏、不喜欢、颜色分类与跨设备同步，并新增个人论文库入口。
* **2026-06-03** 📈 月报升级为周报同款视觉体系下的高层趋势仪表盘，新增主题环比、周际演化、词频云、主题共现图谱和下月观察。
