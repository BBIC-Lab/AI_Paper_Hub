-- Keep only arXiv recent-1-month data in bge-m3 shadow tables.
-- Cutoff date is based on current date 2026-06-14: keep published >= 2026-05-14 UTC.
...
select 'before_arxiv_recent1m' as label, count(*) as rows
from public.arxiv_papers_bge_m3
where published >= timestamptz '2026-05-14 00:00:00+00';
...
-- Enforce recent-1-month arxiv window.
delete from public.arxiv_papers_bge_m3
where published is null
   or published < timestamptz '2026-05-14 00:00:00+00';
